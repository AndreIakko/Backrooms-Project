...
MBT.BackRooms = {
    {
        Type = "Exit",
        Coords = vector3(310.52, 5522.78, 14.51),
        Range = 1.5,
        Label = "Passes through"
    },
    {
        Type = "Exit",
        Coords = vector3(1779.16, -260.81, 20.86),
        Range = 1.5,
        Label = "Passes through"
    },
    {
        Type = "Exit",
        Coords = vector3(-2301.72, 1416.78, 81.92),
        Range = 1.5,
        Label = "Passes through"
    },
    {
        Type = "Exit",
        Coords = vector3(1017.94, 800.23, 25.92),
        Range = 1.5,
        Label = "Passes through"
    },
    {
        Type = "Enter",
        Coords = vector3(1112.08, 2188.65, 46.39),
        Range = 2,
        Label = "Passes through"
    },
    {
        Type = "Enter",
        Coords = vector3(-220.38, 3649.13, 51.75),
        Range = 2,
        Label = "Passes through"
    },
    {
        Type = "Enter",
        Coords = vector3(-440.85, 1598.89, 358.47),
        Range = 2,
        Label = "Passes through"
    },
    {
        Type = "Enter",
        Coords = vector3(1665.08, -28.03, 196.94),
        Range = 2,
        Label = "Passes through"
    },
    {
        Type = "Enter",
        Coords = vector3(3426.76, 5174.49, 7.41),
        Range = 2,
        Label = "Passes through"
    }
}